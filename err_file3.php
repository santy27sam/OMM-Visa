...
<table class="t1">
	<tr class="tr">
	<td onclick="setColor(event)"; data-count="0"/><b><i><pre style="font-size: 12px; font-family: times;">			    											       Total Purchases                   2, 829. 70
	</i>
</b>
</td>
</pre>
...
<div class="p12" onclick="setColor(event)"; data-count="0"/><table class="t1" style="width:100% ">
  <tr class="tr"><div id= "c1" onclick="stopTimer(this), setColor(event)"; data-count="0"/>Payments and Credits</div>
